...
let tickets: Ticket[] = [
  ...
  },
  {
    id: "tkt-002",
    title: "Cập nhật logo",
    description: "Thay đổi logo công ty trên navbar",
    status: "Done",
    createdAt: new Date().toISOString(),
  },
  {
    ...
    description: "Cổng thanh toán Stripe bị từ chối",
    status: "In Progress",
    createdAt: new Date().toISOString(),
  },
  {
    ...
    description: "Khách hàng yêu cầu giao diện tối",
    status: "Open",
    createdAt: new Date().toISOString(),
  },
  {
    id: "tkt-005",
    title: "Sai chính tả footer",
    description: "Tên công ty bị viết sai",
    status: "Done",
    createdAt: new Date().toISOString(),
  },
];
...
let comments: Comment[] = [
  {
    id: "cmt-001",
    ticketId: "tkt-001",
    content: "Tôi đang kiểm tra lỗi này.",
    createdAt: new Date().toISOString(),
  },
  {
    id: "cmt-002",
    ticketId: "tkt-001",
    content: "Đã sửa xong trong bản deploy mới nhất.",
    createdAt: new Date().toISOString(),
  },
];
...
export const mockApi = {
  ...
  getTicketById: async (id: string): Promise<Ticket & { comments: Comment[] }> => {
    await delay(400);
